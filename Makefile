#############################################################################
# Makefile for building: reversi_game.app/Contents/MacOS/reversi_game
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  reversi.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile reversi.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = reversi_game1.0.0
DISTDIR = /Users/patrick/Library/Mobile\ Documents/com~apple~CloudDocs/VScode\ local/playground/group10/.tmp/reversi_game1.0.0
...
SOURCES       = main.cpp \
		...
		MyReversiInput.cpp \
		MyReversiView.cpp moc_ReversiWindow.cpp \
		moc_MyReversiInput.cpp
OBJECTS       = main.o \
		ReversiGame.o \
		ReversiWindow.o \
		MyReversiContext.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		MyReversiContext.h \
		MyReversiInput.h \
		MyReversiView.h main.cpp \
		ReversiGame.cpp \
		ReversiWindow.cpp \
		MyReversiContext.cpp \
		MyReversiInput.cpp \
		MyReversiView.cpp
QMAKE_TARGET  = reversi_game
DESTDIR       = 
TARGET        = reversi_game.app/Contents/MacOS/reversi_game
...
EXPORT__PRO_FILE_ = /Users/patrick/Library/Mobile Documents/com~apple~CloudDocs/VScode local/playground/group10/reversi.pro
...
reversi_game.app/Contents/MacOS/reversi_game:  $(OBJECTS)  
	@test -d reversi_game.app/Contents/MacOS/ || mkdir -p reversi_game.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: reversi.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
...
reversi_game.app/Contents/PkgInfo: 
	@test -d reversi_game.app/Contents || mkdir -p reversi_game.app/Contents
	@$(DEL_FILE) reversi_game.app/Contents/PkgInfo
	@echo "APPL????" > reversi_game.app/Contents/PkgInfo
reversi_game.app/Contents/Info.plist: 
	@test -d reversi_game.app/Contents || mkdir -p reversi_game.app/Contents
	@$(DEL_FILE) reversi_game.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.pami.reversi-game,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.pami.reversi-game,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,reversi_game,g" -e "s,@LIBRARY@,reversi_game,g" -e "s,\$${EXECUTABLE_NAME},reversi_game,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >reversi_game.app/Contents/Info.plist

all: Makefile \
		reversi_game.app/Contents/PkgInfo \
		reversi_game.app/Contents/Info.plist reversi_game.app/Contents/MacOS/reversi_game
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ReversiDefine.h ReversiWindow.h ReversiGame.h IReversiView.h IReversiInput.h IReversiContext.h MyReversiContext.h MyReversiInput.h MyReversiView.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp ReversiGame.cpp ReversiWindow.cpp MyReversiContext.cpp MyReversiInput.cpp MyReversiView.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_ReversiWindow.cpp moc_MyReversiInput.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ReversiWindow.cpp moc_MyReversiInput.cpp
moc_ReversiWindow.cpp: ReversiWindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/patrick/Library/Mobile Documents/com~apple~CloudDocs/VScode local/playground/group10/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/patrick/Library/Mobile Documents/com~apple~CloudDocs/VScode local/playground/group10' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib ReversiWindow.h -o moc_ReversiWindow.cpp

moc_MyReversiInput.cpp: MyReversiInput.h \
		MyReversiView.h \
		IReversiView.h \
		ReversiDefine.h \
		IReversiContext.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/patrick/Library/Mobile Documents/com~apple~CloudDocs/VScode local/playground/group10/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/patrick/Library/Mobile Documents/com~apple~CloudDocs/VScode local/playground/group10' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib MyReversiInput.h -o moc_MyReversiInput.cpp
...
ReversiGame.o: ReversiGame.cpp ReversiGame.h \
		...
		IReversiView.h \
		MyReversiContext.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ReversiGame.o ReversiGame.cpp

ReversiWindow.o: ReversiWindow.cpp ReversiWindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ReversiWindow.o ReversiWindow.cpp

MyReversiContext.o: MyReversiContext.cpp MyReversiContext.h \
		IReversiContext.h \
		ReversiDefine.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyReversiContext.o MyReversiContext.cpp

MyReversiInput.o: MyReversiInput.cpp MyReversiInput.h \
		MyReversiView.h \
		IReversiView.h \
		ReversiDefine.h \
		IReversiContext.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyReversiInput.o MyReversiInput.cpp

MyReversiView.o: MyReversiView.cpp MyReversiView.h \
		IReversiView.h \
		ReversiDefine.h \
		IReversiContext.h \
		ReversiWindow.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QLabel \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlabel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyReversiView.o MyReversiView.cpp

moc_ReversiWindow.o: moc_ReversiWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ReversiWindow.o moc_ReversiWindow.cpp

moc_MyReversiInput.o: moc_MyReversiInput.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_MyReversiInput.o moc_MyReversiInput.cpp
